...
$salons = [
    ...
    [
        'id' => 5,
        'name' => 'Pawsome Beauty',
        'address' => 'Caddebostan Sahil Yolu No:42',
        'district' => 'Kadıköy',
        'city' => 'İstanbul',
        'rating' => 4.6,
        'review_count' => 189,
        'phone' => '0216 555 66 77',
        'description' => 'Deneyimli ekibimizle dostlarınıza özel bakım',
        'opens_at' => '09:00',
        'closes_at' => '19:00',
        'image' => 'static/img/salon2.jpg',
        'services' => ['Kedi Tıraşı', 'Köpek Tıraşı', 'Yıkama']
    ],
    [
        'id' => 6,
        'name' => 'PetFashion',
        ...
        'description' => 'Modern ekipmanlarla profesyonel bakım',
        'opens_at' => '08:00',
        'closes_at' => '20:00',
        'image' => 'static/img/salon3.jpg',
        'services' => ['Kedi Bakımı', 'Köpek Bakımı', 'Tırnak Bakımı']
    ],
    [
        'id' => 7,
        'name' => 'Royal Pets Salon',
        'address' => 'İstiklal Caddesi No:76',
        'district' => 'Beyoğlu',
        'city' => 'İstanbul',
        'rating' => 4.7,
        'review_count' => 134,
        'phone' => '0212 777 88 99',
        'description' => 'Evcil dostlarınız için royal bakım',
        'opens_at' => '10:00',
        'closes_at' => '22:00',
        'image' => 'static/img/salon1.jpg',
        'services' => ['Kedi Güzellik', 'Köpek Güzellik', 'Masaj Terapisi']
    ],
    [
        'id' => 8,
        'name' => 'Pet Paradise',
        'address' => 'Bağlar Caddesi No:23',
        'district' => 'Etiler',
        'city' => 'İstanbul',
        'rating' => 4.9,
        'review_count' => 289,
        'phone' => '0212 888 99 00',
        'description' => 'Evcil hayvanlar için cennet',
        'opens_at' => '09:00',
        'closes_at' => '21:00',
        'image' => 'static/img/salon2.jpg',
        'services' => ['Kedi Spa', 'Köpek Spa', 'Özel Bakım Paketleri']
    ]
];
